...
class SBI_Support {
	...
	public function support_page_enqueue_assets() {
		...
		if ( 'instagram-feed_page_sbi-support' !== $screen->id ) {
			return;
		}
			...
			'articles'            => array(
				'gettingStarted' => array(
					array(
						...
						'link'  => 'https://smashballoon.com/doc/setting-up-the-instagram-feed-pro-wordpress-plugin/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Creating your first Instagram feed',
					),
					array(
						'title' => __( 'Instagram Business Profiles (required for Hashtag and Tagged feeds)', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/instagram-business-profiles/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Instagram Business Profiles',
					),
					array(
						'title' => __( 'Multiple User Accounts in One Feed', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/displaying-photos-multiple-ids-hashtags-feed/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Multiple Users',
					),
				),
				'docs'           => array(
					array(
						'title' => __( 'Displaying Instagram Hashtag Feeds', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/displaying-an-instagram-hashtag-feed-on-your-website/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Displaying an Instagram Hashtag Feed',
					),
					array(
						'title' => __( 'How to Resolve Error Messages', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/instagram-api-error-message-reference/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Instagram resolving error messages',
					),
					array(
						'title' => __( 'My Feed Stopped Working or is Empty', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/my-photos-wont-load/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=My feed stopped working',
					),
				),
				'resources'      => array(
					array(
						'title' => __( 'Differences Between an Instagram Personal and Business Account', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/differences-between-an-instagram-personal-and-business-account/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Differences between a business and personal account',
					),
					array(
						'title' => __( 'Display Posts With a Specific Hashtag From a Specific User Account', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/can-display-photos-specific-hashtag-specific-user-id/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Display a specific hashtag from a specific account',
					),
					array(
						'title' => __( 'Reauthorizing our Instagram/Facebook App', 'instagram-feed' ),
						'link'  => 'https://smashballoon.com/doc/reauthorizing-our-instagram-facebook-app/?utm_campaign=instagram-pro&utm_source=support&utm_medium=docs&utm_content=Reauthorizing the Instagram or FB app',
					),
				),
			),
		);
	...
	public static function get_global_settings_info() {
		...
		$output .= isset( $sbi_settings['sb_instagram_preserve_settings'] ) && ( $sbi_settings['sb_instagram_preserve_settings'] ) ? 'Yes' : 'No';
		$output .= '</br>';
