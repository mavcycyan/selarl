...
$feed_atts       = SB_Instagram_Display_Elements_Pro::get_feed_container_data_attributes( $settings );
...
$post_style = ! empty( $settings['poststyle'] ) ? 'data-post-style="' . $settings['poststyle'] . ' ' : '';
if (sbi_doing_customizer( $settings )) {
	$post_style = ':data-post-style="customizerFeedData.settings.poststyle" ';
}
?>

<div
id="sb_instagram"
<?php echo $feed_classes . $feed_styles; ?>
<?php echo esc_attr( $post_style ); ?>
